      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-amber-500 rounded-lg p-4 lg:p-6 shadow-lg hidden md:block">
              <span className="text-2xl lg:text-3xl font-bold text-white">25+</span>
              <p className="text-white font-medium text-sm lg:text-base">Years of Excellence</p>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-8">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <span className="block text-2xl lg:text-3xl font-bold text-slate-800 dark:text-white mb-1">{stat.value}</span>
