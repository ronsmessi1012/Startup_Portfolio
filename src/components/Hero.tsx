...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900/95 to-slate-900/70 dark:from-slate-950/95 dark:to-slate-950/70" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex items-center relative z-10">
        <div className="w-full max-w-3xl">
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg md:text-xl text-slate-200 mb-8 max-w-2xl"
          >
          ...
          >
            <Link 
              to="/projects" 
              className="bg-amber-600 hover:bg-amber-700 text-white font-medium py-3 px-6 rounded-md transition duration-300 flex items-center justify-center text-center"
            >
            ...
            <Link 
              to="/contact" 
              className="border border-white hover:border-amber-400 text-white hover:text-amber-400 font-medium py-3 px-6 rounded-md transition duration-300 flex items-center justify-center text-center"
            >
              Contact Us
            </Link>
          </motion.div>
