...
const TestimonialsSection: React.FC = () => {
  const testimonials: Testimonial[] = [
    {
      id: 1,
      quote: "New Design O Craft transformed our concept into a stunning reality. Their attention to detail and innovative approach exceeded our expectations.",
    ...
    {
      id: 3,
      quote: "The residential design New Design O Craft created for us beautifully balances modern aesthetics with comfort and practicality.",
      author: "Sujit Biswas",
      position: "Home Owner",
      rating: 5,
      image: kireeti
    ...
    {
      id: 5,
      quote: "Working with New Design O Craft was the best decision we made during our home construction. The team was patient, professional, and brought our vision to life.",
  ...
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-900 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-800 dark:text-white mb-4">Client Testimonials</h2>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex justify-center mt-8 gap-4">
            <button
              onClick={handlePrev}
              className="w-10 h-10 rounded-full bg-white dark:bg-slate-700 shadow-md flex items-center justify-center text-slate-800 dark:text-white hover:bg-amber-500 hover:text-white transition-colors"
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors ${
                  currentIndex === index ? 'bg-amber-500' : 'bg-slate-300 dark:bg-slate-600'
                }`}
