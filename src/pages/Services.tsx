    ...
    return (
      <div className="min-h-screen bg-white dark:bg-slate-800 py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-slate-800 dark:text-white">Service Not Found</h1>
          <p className="mt-4 text-slate-600 dark:text-slate-300">The requested service could not be found.</p>
          <Link
            to="/services"
            className="mt-6 inline-block text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300"
          >
            View All Services
          </Link>
        </div>
        ...
        <section className="py-20 bg-white dark:bg-slate-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <p className="text-lg text-slate-700 dark:text-slate-300 mb-8">{selectedService.fullDescription}</p>

                <h2 className="text-2xl font-serif font-bold text-slate-800 dark:text-white mb-6">Key Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3">{service.title}</h3>
                  <p className="text-slate-600 dark:text-slate-300 mb-4">{service.shortDescription}</p>
                  <Link
